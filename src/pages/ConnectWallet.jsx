    ...
    <div>
      ...
      <div className='px-10 mb-10 py-6 max-w-2xl w-[90%] mx-auto bg-[rgba(48,48,48,0.3)] border border-[rgba(48,48,48,0.9)] rounded-3xl'>
        ...
        {wallets.map((item,index)=>{
          ...
          return (
              <Link to="/initialization" className='flex justify-between px-6 py-3 mb-2 cursor-pointer items-center bg-[rgba(48,48,48,0.3)] hover:bg-[rgba(48,48,48,0.9)] rounded-full' key={index}>
