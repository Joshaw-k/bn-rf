...
const Hero = () => {
  return (
      ...
      <div className='flex flex-col md:flex-row gap-y-3 justify-between md:w-[50%] mx-auto'>
        <button className='py-3 px-4 lg:px-8 md:w-[48%] bg-[rgba(0,201,32,1)] rounded-full font-bold hover:text-[rgba(0,201,32,1)] hover:bg-white'><Link to='/connectwallet'>Connect Wallet</Link></button>
